...
class Quark:
    ...
    def show_summary_report(self, rule_obj):
        ...
        call_graph(self.pre_method0, self.pre_method1, mutual_parent_function=self.mutual_parent_function,
                   crime_description=rule_obj.crime,
                   first_natvie_call=(rule_obj.x2n3n4_comb[0]["class"], rule_obj.x2n3n4_comb[0]["method"]),
                   second_native_call=(rule_obj.x2n3n4_comb[1]["class"], rule_obj.x2n3n4_comb[1]["method"]),
