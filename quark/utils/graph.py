...
def call_graph(first_wrappers_list, second_wrappers_list,
    ...
    dot = Digraph(filename=filename,
                  ...
                  format="svg",
                  graph_attr={"label": "Potential Malicious Activity: " + crime_description, "labelloc": "top",
                              "center": "true"},
                  )
    ...
    with dot.subgraph(name="cluster_0") as wrapper:
        ...
        for wp_func in first_wrappers_list:
            ...
            wrapper.node(wp_cls_name + wp_md_name,
        ...
        for i in range(len(first_wrappers_list) - 1, 0, -1):
            ...
            wrapper.edge(wp_cls_name_1 + wp_md_name_1, wp_cls_name_2 + wp_md_name_2, "calls", fontname="Courier New")
    ...
    dot.edge(mutual_method_name, first_wp_cls_name_1 + first_wp_md_name_1, "First Call", fontname="Courier New")
    dot.edge(mutual_method_name, first_wp_cls_name_2 + first_wp_md_name_2, "Second Call", fontname="Courier New")
    ...
    dot.edge(last_wp_cls_name_1 + last_wp_md_name_1, first_native_method, "calls", fontname="Courier New")
    dot.edge(last_wp_cls_name_2 + last_wp_md_name_2, second_native_method, "calls", fontname="Courier New")

    dot.edge(first_native_method, "permission", "requests", fontname="Courier New", lhead='cluster_permission')
    dot.edge(second_native_method, "permission", "requests", fontname="Courier New", lhead='cluster_permission')
